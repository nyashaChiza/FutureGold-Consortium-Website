...
?>
  ...
  <main id="main" data-aos="fade-in">
    ...
    <div class="breadcrumbs">
      <div class="container">
        <h2>Courses</h2>
        <p>The world’s leading financial markets education provider. </p>
      </div>
    </div><!-- End Breadcrumbs -->
            ...
            <div class="course-item">
              ...
              <div class="course-content">
                ...
                <ul style='list-style-type: none;'>
                  ...
                  <li><i class="bi bi-check-circle"></i> Basic Price Action Concepts</li>
          ...
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
            <div class="course-item">
              ...
              <div class="course-content">
                ...
                <ul style='list-style-type: none;'>
                  <li><i class="bi bi-check-circle"></i> Intermarket Relationships </li>
                  <li><i class="bi bi-check-circle"></i> Building a Strategy </li>
